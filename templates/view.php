...
<div class="wm-toolbar">
    ...
    <form method="post" action="?action=delete&folder=<?= $folderEnc ?>&msg=<?= $msgNo ?>" style="display:inline" id="delete-msg-form">
        <?= csrfInput() ?>
...
(function() {
    ...
    const moveForm = document.getElementById('move-msg-form');
    if (moveForm) {
        moveForm.addEventListener('submit', function(e) {
            const destination = this.querySelector('select[name="destination"]');
    ...
    const emailShadowCss = [
        ...
        '#wm-shadow-wrapper[data-theme="dark"]{background:var(--wm-surface,#161b22);}',
        '#wm-shadow-wrapper[data-theme="dark"] body,#wm-shadow-wrapper[data-theme="dark"] html{background:var(--wm-surface,#161b22)!important;}'
    ].join('\n');
