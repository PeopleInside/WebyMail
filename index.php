...
header("Content-Security-Policy: default-src 'self'; base-uri 'self'; frame-ancestors 'self'; form-action 'self'; object-src 'none'; script-src 'self' 'nonce-{$cspNonce}'; style-src 'self' 'nonce-{$cspNonce}'; style-src-elem 'self' 'nonce-{$cspNonce}'; style-src-attr 'unsafe-inline'; img-src 'self' data: blob: http: https:; font-src 'self'; connect-src 'self';");
